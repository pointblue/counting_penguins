...
create_validation_shapefiles(db_name = db_name, colony = colony, species = species, date = date)

#4. Run next function to calculate threshold to get max F1 Score

compute_threshold_results(db_name = db_name, colony = colony, species = species, date = date)
